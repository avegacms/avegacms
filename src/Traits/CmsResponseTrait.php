...
trait CmsResponseTrait
{
     ...
     */
    protected function respond($data = null, ?int $status = null, string $message = ''): ResponseInterface
    {
     ...
     * @return ResponseInterface
     */
    protected function failForbidden(
     ...
     * @return ResponseInterface
     */
    protected function failNotFound(
     ...
     * @return ResponseInterface
     */
    protected function failValidationErrors($errors, ?string $code = null, string $message = ''): ResponseInterface
    {
     ...
     * @return ResponseInterface
     */
    protected function failResourceExists(
     ...
     * @return ResponseInterface
     */
    protected function failResourceGone(
     ...
     * @return ResponseInterface
     */
    protected function failTooManyRequests(
     ...
     */
    protected function failServerError(
     ...
     * @return false|string
     */
    protected function format($data = null): false|string
    {
